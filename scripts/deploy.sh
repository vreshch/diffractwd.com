...
# Deployment script for diffractwd.com
...
# Configuration
IMAGE_TAG="${1:-latest}"
IMAGE="ghcr.io/vreshch/diffractwd.com:${IMAGE_TAG}"
STACK_NAME="diffractwd"
COMPOSE_FILE="/opt/diffractwd-com/docker-compose.yml"
VERSION_FILE="/opt/diffractwd-com/.deployed-version"
...
# Start deployment
log "🚀 Starting deployment of diffractwd.com..."
log "📦 Image: $IMAGE"
...
if [ "$RUNNING_COUNT" -gt 0 ]; then
    ...
    echo ""
    echo "🌐 Website: https://diffractwd.com"
