...
export default function NewsPage() {
    return (
        <div>
            <Head>
                <title>DiffractWD - News</title>
            </Head>
            <h1>News</h1>
            <hr />
            <div className="app-text">
                <dl>
                    <dt>Website updated (17-October-2021)</dt>
                    <dd>Website core moved to TypeScript,NextJS</dd>
                </dl>
                <dl>
                ...
                <dl>
                    ...
                    <dd>Windows Vista and Windows 7 support</dd>
